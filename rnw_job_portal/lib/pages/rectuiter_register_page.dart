...
class RecruiterRegisterScreen extends StatefulWidget {
  RecruiterRegisterScreen({Key key}) : super(key: key);

  @override
  _RecruiterRegisterScreenState createState() =>
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: Stack(
            children: <Widget>[
              InAppWebView(
                initialUrl: "https://demo.rnwmultimedia.com/recruiter/recruiter_register.php",
